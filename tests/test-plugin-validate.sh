...
FAIL=0
TOTAL=0
REFERENCE_NAMES="audit command-prelude compilation hub-resolution indexing ingestion inventory librarian linting projects research-infrastructure wiki-structure"
